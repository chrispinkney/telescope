...
const getUser = async () => {
  const response = await request(app).get('/user/10001');
  return response;
};
...
const postUser1 = async () => {
  ...
  const response = await request(app).post('/user').set('Accept', 'application/json').send(user);
...
describe('POST REQUESTS', () => {
  ...
  test('Post JSON, Rejected - Feeds array must only contain strings', async () => {
    ...
    const response = await request(app).post('/user').set('Accept', 'application/json').send(body);
...
describe('DELETE REQUESTS', () => {
  ...
  test('Delete JSON, Accepted - deleted an existing user', async () => {
    ...
    const response = await request(app).delete('/user/10001').set('Accept', 'application/json');
